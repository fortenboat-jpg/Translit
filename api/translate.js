...
const FIELDS = [
  { id:'stateRegNum',      top:15.7, left:30.1, size:16 },
  { id:'dateIssued',       top:15.4, left:62.9, size:16 },
  { id:'dateRegistered',   top:17.5, left:62.9, size:16 },
  { id:'childName',        top:22.3, left:33.6, size:16 },
  { id:'dobFormatted',     top:27.2, left:33.6, size:16 },
  { id:'timeOfBirth',      top:27.5, left:78.7, size:16 },
  { id:'sex',              top:31.5, left:33.6, size:16 },
  { id:'weight',           top:31.7, left:70.5, size:16 },
  { id:'hospital',         top:35.0, left:33.6, size:16 },
  { id:'hospitalLine2',    top:36.9, left:33.6, size:16 },
  { id:'cityCounty',       top:38.8, left:33.7, size:16 },
  { id:'motherName',       top:49.7, left:33.5, size:16 },
  { id:'motherDob',        top:53.6, left:33.5, size:16 },
  { id:'motherBirthPlace', top:56.8, left:33.4, size:16 },
  { id:'fatherName',       top:65.9, left:33.4, size:16 },
  { id:'fatherDob',        top:70.4, left:33.4, size:16 },
  { id:'fatherBirthPlace', top:73.9, left:33.5, size:16 },
  { id:'reqNum',           top:85.3, left:75.1, size:16 },
  { id:'barcode',          top:96.6, left:27.9, size:14 },
];

// ── КООРДИНАТЫ ПОЛЕЙ ДЛЯ ВТОРОГО БЛАНКА (bg2.jpg) ──────
const FIELDS2 = [
  { id:'stateRegNum',      top:22.0, left:12.8, size:15 },
  { id:'dateIssued',       top:20.7, left:68.6, size:15 },
  { id:'dateRegistered',   top:22.3, left:73.6, size:15 },
  { id:'childName',        top:26.9, left:38.0, size:15 },
  { id:'dobFormatted',     top:29.4, left:37.7, size:15 },
  { id:'timeOfBirth',      top:29.5, left:84.8, size:15 },
  { id:'sex',              top:32.0, left:37.9, size:15 },
  { id:'weight',           top:32.1, left:76.6, size:15 },
  { id:'hospital',         top:34.4, left:37.7, size:15 },
  { id:'hospitalLine2',    top:36.2, left:37.6, size:15 },
  { id:'cityCounty',       top:38.3, left:37.5, size:15 },
  { id:'motherName',       top:45.2, left:37.8, size:15 },
  { id:'motherDob',        top:47.7, left:37.5, size:15 },
  { id:'motherBirthPlace', top:50.2, left:37.5, size:15 },
  { id:'fatherName',       top:58.2, left:37.9, size:15 },
  { id:'fatherDob',        top:60.8, left:37.9, size:15 },
  { id:'fatherBirthPlace', top:63.4, left:37.7, size:15 },
  { id:'reqNum',           top:66.3, left:71.1, size:15 },
  { id:'barcode',          top:86.8, left:42.7, size:11 },
];
