...
const FIELDS2 = [
  ...
  { id:'childName',        top:25.6, left:37.1, size:15 },
  { id:'dobFormatted',     top:28.3, left:37.0, size:15 },
  { id:'timeOfBirth',      top:28.4, left:84.2, size:15 },
  { id:'sex',              top:30.5, left:37.1, size:15 },
  { id:'weight',           top:31.0, left:75.9, size:15 },
  { id:'hospital',         top:33.5, left:37.2, size:15 },
  { id:'hospitalLine2',    top:35.2, left:37.3, size:15 },
  { id:'cityCounty',       top:37.2, left:37.2, size:15 },
  { id:'motherName',       top:43.8, left:37.8, size:15 },
  { id:'motherDob',        top:46.6, left:37.9, size:15 },
  { id:'motherBirthPlace', top:49.2, left:37.7, size:15 },
  { id:'fatherName',       top:57.2, left:37.8, size:15 },
  { id:'fatherDob',        top:59.7, left:37.9, size:15 },
  { id:'fatherBirthPlace', top:62.4, left:37.7, size:15 },
  { id:'reqNum',           top:65.2, left:70.8, size:15 },
