...
const FIELDS = [
  { id:'stateRegNum',      top:15.35, left:30.1, size:16 },
  { id:'dateIssued',       top:15.05, left:62.9, size:16 },
  { id:'dateRegistered',   top:17.15, left:62.9, size:16 },
  { id:'childName',        top:21.95, left:33.6, size:16 },
  { id:'dobFormatted',     top:26.85, left:33.6, size:16 },
  { id:'timeOfBirth',      top:27.15, left:78.7, size:16 },
  { id:'sex',              top:31.15, left:33.6, size:16 },
  { id:'weight',           top:31.35, left:70.5, size:16 },
  { id:'hospital',         top:34.65, left:33.6, size:16 },
  { id:'hospitalLine2',    top:36.55, left:33.6, size:16 },
  { id:'cityCounty',       top:38.45, left:33.7, size:16 },
  { id:'motherName',       top:49.35, left:33.5, size:16 },
  { id:'motherDob',        top:53.25, left:33.5, size:16 },
  { id:'motherBirthPlace', top:56.45, left:33.4, size:16 },
  { id:'fatherName',       top:65.55, left:33.4, size:16 },
  { id:'fatherDob',        top:70.05, left:33.4, size:16 },
  { id:'fatherBirthPlace', top:73.55, left:33.5, size:16 },
  { id:'reqNum',           top:84.95, left:75.1, size:16 },
  { id:'barcode',          top:96.6, left:27.9, size:14 },
];

// ── КООРДИНАТЫ ПОЛЕЙ ДЛЯ ВТОРОГО БЛАНКА (bg2.jpg) ──────
const FIELDS2 = [
  { id:'stateRegNum',      top:21.65, left:12.8, size:15 },
  { id:'dateIssued',       top:20.35, left:68.6, size:15 },
  { id:'dateRegistered',   top:21.95, left:73.6, size:15 },
  { id:'childName',        top:26.55, left:38.0, size:15 },
  { id:'dobFormatted',     top:29.05, left:37.7, size:15 },
  { id:'timeOfBirth',      top:29.15, left:84.8, size:15 },
  { id:'sex',              top:31.65, left:37.9, size:15 },
  { id:'weight',           top:31.75, left:76.6, size:15 },
  { id:'hospital',         top:34.05, left:37.7, size:15 },
  { id:'hospitalLine2',    top:35.85, left:37.6, size:15 },
  { id:'cityCounty',       top:37.95, left:37.5, size:15 },
  { id:'motherName',       top:44.85, left:37.8, size:15 },
  { id:'motherDob',        top:47.35, left:37.5, size:15 },
  { id:'motherBirthPlace', top:49.85, left:37.5, size:15 },
  { id:'fatherName',       top:57.85, left:37.9, size:15 },
  { id:'fatherDob',        top:60.45, left:37.9, size:15 },
  { id:'fatherBirthPlace', top:63.05, left:37.7, size:15 },
  { id:'reqNum',           top:65.95, left:71.1, size:15 },
  { id:'barcode',          top:86.45, left:42.7, size:11 },
];
