...
const FIELDS2 = [
  { id:'stateRegNum',      top:21.3, left:12.2, size:25 },
  { id:'dateIssued',       top:19.6, left:67.8, size:25 },
  { id:'dateRegistered',   top:21.3, left:72.9, size:25 },
  { id:'childName',        top:25.6, left:37.1, size:25 },
  { id:'dobFormatted',     top:28.3, left:37.0, size:25 },
  { id:'timeOfBirth',      top:28.4, left:84.2, size:25 },
  { id:'sex',              top:30.5, left:37.1, size:25 },
  { id:'weight',           top:31.0, left:75.9, size:25 },
  { id:'hospitalType',     top:33.5, left:37.2, size:25 },
  { id:'hospital',         top:35.2, left:37.3, size:25 },
  { id:'cityCounty',       top:37.2, left:37.2, size:25 },
  { id:'motherName',       top:43.8, left:37.8, size:25 },
  { id:'motherDob',        top:46.6, left:37.9, size:25 },
  { id:'motherBirthPlace', top:49.2, left:37.7, size:25 },
  { id:'fatherName',       top:57.2, left:37.8, size:25 },
  { id:'fatherDob',        top:59.7, left:37.9, size:25 },
  { id:'fatherBirthPlace', top:62.4, left:37.7, size:25 },
  { id:'reqNum',           top:65.2, left:70.8, size:25 },
  { id:'barcode',          top:85.2, left:35.9, size:17 },
];
