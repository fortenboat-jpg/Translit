...
const FIELDS = [
  { id:'stateRegNum',      top:15.0, left:30.1, size:20 },
  { id:'dateIssued',       top:15.0, left:64.3, size:20 },
  { id:'dateRegistered',   top:17.0, left:64.4, size:20 },
  { id:'childName',        top:21.8, left:33.6, size:20 },
  { id:'dobFormatted',     top:26.5, left:33.6, size:20 },
  { id:'timeOfBirth',      top:27.0, left:79.1, size:20 },
  { id:'sex',              top:31.0, left:33.6, size:20 },
  { id:'weight',           top:31.0, left:71.1, size:20 },
  { id:'hospital',         top:34.4, left:33.6, size:20 },
  { id:'cityCounty',       top:38.3, left:33.7, size:20 },
  { id:'motherName',       top:49.3, left:33.5, size:20 },
  { id:'motherDob',        top:53.1, left:33.5, size:20 },
  { id:'motherBirthPlace', top:56.3, left:33.4, size:20 },
  { id:'fatherName',       top:65.5, left:33.4, size:20 },
  { id:'fatherDob',        top:69.9, left:33.4, size:20 },
  { id:'fatherBirthPlace', top:73.5, left:33.5, size:20 },
  { id:'reqNum',           top:84.6, left:75.1, size:20 },
  { id:'barcode',          top:96.6, left:17.9, size:17 },
];
